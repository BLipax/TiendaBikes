...
from productos.views import pago_exitoso, webpay_respuesta
...
urlpatterns = [
    path('', ProductoList.as_view(), name='producto-list'),  # quitar 'productos/' aquí para evitar duplicar la palabra en URL
